...
$expectedSource = 'sha256:e1fb2c186c86b89321f0fb3cb2d6e8b0108b051bf7de7ffee7d4f6d94ed1b60c'
$expectedTarget = 'sha256:86f39ecb264554cd53b2152d8ff138624b11709178f56be109e3047ee3cb7ecf'
$composeArgs = @('compose', '-p', $project, '-f', 'docker-compose.yml',
    ...
    '-f', 'infra/docker/document-export-boundary.compose.yml')
$previousEnv = @{}
